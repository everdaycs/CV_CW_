        ...
        if rank in [-1, 0]:
            ...
            if tb_writer:
                tags = ['train/giou_loss', 'train/obj_loss', 'train/cls_loss',
                        ...
                        'valid/giou_loss', 'valid/obj_loss', 'valid/cls_loss']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/Yancheng_Chen/桌面/DeepSORT_YOLOv5_Pytorch/yolov5/models/yolov5l.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/Yancheng_Chen/桌面/DeepSORT_YOLOv5_Pytorch/data/all/data.yaml', help='data.yaml path')
